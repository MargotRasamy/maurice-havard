      ...
      <div className="container">
        <div className="row g-5 align-items-start">
          ...
          <div className="col-lg-6 col-md-7 wow fadeInUp" data-aos="fade-in" data-aos-delay="30">
            ...
            <h1 className="display-5 mb-4">Maurice HAVARD, expert piscines et jardins dans le Gers depuis 1971</h1>
            <p className="mb-4">Avec plus de cinquante ans d'expertise dans la création et l'aménagement d'espaces extérieurs dans le Gers, nous donnons vie à vos rêves de jardins. Maurice HAVARD allie créativité et expertise en piscines et jardins pour créer des paysages magnifiques et durables qui valorisent votre propriété.</p>
